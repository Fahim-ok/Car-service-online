...
<style>
body {background-color: #cf0401;}

.container {
  background-image: url("img/bookingman.jpg");
  ...
  <div class="col-lg-8">
    <table class="table table-bordered">
      ...
      <tr class="adminlays">
       ...
       <button type="submit"  name="place_order" class="btn-rak"><?php echo "Confirm"?></button>
       <style>
        .btn-rak{
          background-color: white;
        }
...
<div>
<h2 style="text-align: center;" class="adminlay">Available Mechanic</h2>
        ...
        for ($i=1; $i < 6; $i++) { 
          echo '
            <div class="progress" style="background-color: red;">
              <div class="progress-bar progress-bar-striped" role="progressbar" style="color:yellow; background-color:#red; width: ' . $avaiableMechanic[$i]*20 . '%" aria-valuenow="' . $avaiableMechanic[$i]*20 . '" aria-valuemin="0" aria-valuemax="100">Mechanic ' . $i . '
              </div>
            </div>
          ';
        }
